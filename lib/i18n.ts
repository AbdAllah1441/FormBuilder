...
export const translations = {
  en: {
    ...
    "createForms": "Create dynamic, beautiful forms with ease. Drag, drop, and customize to your heart's content.",
    ...
    "multipleChoice": "Multiple Choice (Radio)",
    ...
    // Form preview
    "noQuestionsPreview": "No questions to preview. Add questions in the builder!",
    ...
    "formNotFoundDesc": "The form you're looking for doesn't exist or has been removed.",
    "goToFormBuilder": "Go to Form Builder",
  },
  ar: {
    // Main page
    "formBuilder": "منشئ النماذج",
    "createForms": "أنشئ نماذج جميلة وديناميكية بسهولة. اسحب وأفلت وخصص كما تشاء.",
    ...
    "multipleChoice": "اختيار متعدد (راديو)",
